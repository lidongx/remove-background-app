...
var $r = U(() => {
  ...
  Ma = typeof location > "u" ? void 0 : location.origin, jp = () => {
    var _a2;
    if (true) return ((_a2 = import.meta.url) == null ? void 0 : _a2.startsWith("file:")) ? new URL(new URL("ort.webgpu.bundle.min.mjs", import.meta.url).href, Ma).href : import.meta.url;
  }, Ve = jp(), Ra = () => {
...
onnxruntime-web/dist/ort.webgpu.bundle.min.mjs:
   ...
   *)
*/
//# sourceMappingURL=ort.webgpu.bundle.min-FOFNA33U.js.map
